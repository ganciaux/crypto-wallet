...
const cryptoFormat = (dataApi, api) => {
  ...
  switch (api) {
    ...
    case 'coinapi':
      return {
        ...data,
        id: dataApi.asset_id,
        symbol: dataApi.asset_id,
        name: dataApi.name,
        image: dataApi.id_icon,
        current_price: dataApi.price_usd,
      }
    default:
      break
  }
...
console.log(cryptoFormat(coinapi, CRYPTO_API_COINAPI))
console.log(cryptoFormat(coinGecko, CRYPTO_API_GECKO))
